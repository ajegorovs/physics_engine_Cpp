...
void Resources::connect(std::shared_ptr<Device> env, std::shared_ptr<Image> env2) { dvc = env; img = env2; };
...
VkShaderModule Resources::createShaderModule(const std::vector<char>& code) {
...
void Resources::createGraphicsPipeline() {
...
void Resources::transitionImageLayout(VkImage image, VkFormat format, VkImageLayout oldLayout, VkImageLayout newLayout, uint32_t mipLevels) {
...
void Resources::copyBufferToImage(VkBuffer buffer, VkImage image, uint32_t width, uint32_t height) {
    VkCommandBuffer commandBuffer = beginSingleTimeCommands();
...
void Resources::generateMipmaps(VkImage image, VkFormat imageFormat, int32_t texWidth, int32_t texHeight, uint32_t mipLevels) {
...
VkImageView Resources::createImageView(VkImage image, VkFormat format, VkImageAspectFlags aspectFlags, uint32_t mipLevels) {
...
void Resources::createTextureImage() {
...
void Resources::copyBuffer(VkBuffer srcBuffer, VkBuffer dstBuffer, VkDeviceSize size) {
    VkCommandBuffer commandBuffer = beginSingleTimeCommands();
