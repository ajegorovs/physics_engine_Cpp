...
// Vulkan init
void Resources::createColorResources(VkFormat swapChainImageFormat, VkExtent2D swapChainExtent) {
...
// Vulkan init;
void Resources::createDepthResources(VkFormat depthFormat, VkExtent2D swapChainExtent) {
    createImage(swapChainExtent.width, swapChainExtent.height, 1, *msaaSamples, depthFormat, VK_IMAGE_TILING_OPTIMAL, VK_IMAGE_USAGE_DEPTH_STENCIL_ATTACHMENT_BIT, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, depthImage, depthImageMemory);
    depthImageView = createImageView(depthImage, depthFormat, VK_IMAGE_ASPECT_DEPTH_BIT, 1);
}

// Vulkan init;
void Resources::createFramebuffers(std::vector<VkFramebuffer>& swapChainFramebuffers, const std::vector<VkImageView>& swapChainImageViews, VkRenderPass renderPass, VkExtent2D swapChainExtent) {
...
void Resources::copyBufferToImage(Commands cmd, VkQueue graphicsQueue, VkBuffer buffer, VkImage image, uint32_t width, uint32_t height) {
...
void Resources::generateMipmaps(Commands cmd, VkQueue graphicsQueue, VkImage image, VkFormat imageFormat, int32_t texWidth, int32_t texHeight, uint32_t mipLevels) {
...
void Resources::createTextureImage(Commands cmd, VkQueue graphicsQueue) {
...
void Resources::createDescriptorSets(VkDescriptorSetLayout descriptorSetLayout, std::vector<VkBuffer> uniformBuffers, std::vector<VkBuffer> storageBuffers) {
...
void Resources::cleanupSwapChain1() {
