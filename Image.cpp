...
void Image::connect(std::shared_ptr<Device> env) { dvc = env; };

void Image::cleanupSwapChain() {
...
VkSurfaceFormatKHR Image::chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& availableFormats) {
...
VkPresentModeKHR Image::chooseSwapPresentMode(const std::vector<VkPresentModeKHR>& availablePresentModes) {
...
VkExtent2D Image::chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities) {
