...
private:
    ...
    void formPlane(float height, float sideLength) {
        float a = sideLength / 2;
        std::vector<Vertex> planeVerts = {
            {{-a, -a,height}, {1.0f, 1.0f, 1.0f}, {0.0f, 0.0f}, 0.0f},
            {{a, -a, height}, {1.0f, 1.0f, 1.0f}, {1.0f, 0.0f}, 0.0f},
            {{a, a, height}, {1.0f, 1.0f, 1.0f}, {1.0f, 1.0f}, 0.0f},
